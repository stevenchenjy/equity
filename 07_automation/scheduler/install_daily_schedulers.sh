...
launcher_dir="/Users/messssi/Library/Application Support/EquityResearch/bin"
launcher_template="${project_root}/07_automation/scheduler/dailyrefresh_launcher.py.template"
launcher_path="${launcher_dir}/dailyrefresh_launcher.py"
runtime_wrapper="${project_root}/09_scripts/equity_research/run_runtime_scheduler.py"
...
for legacy_suffix in dailyrefresh dailydecision dailybrief weeklyconviction weeklycatchup; do
...
for job_suffix in dailyrefresh dailydecision; do
    job_label="com.steven.equity_research.${job_suffix}"
