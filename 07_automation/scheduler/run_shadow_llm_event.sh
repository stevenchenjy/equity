...
runner="${project_root}/09_scripts/equity_research/run_shadow_llm_evaluation.py"
evaluator="${project_root}/09_scripts/equity_research/evaluate_shadow_llm_incremental_value.py"
packet="${project_root}/03_source_data/equity_research/llm_evidence_packet.json"
runs_root="${project_root}/08_reviews/shadow_llm/runs.local"
evaluation_output="${project_root}/08_reviews/shadow_llm/reviews.local/evaluation.json"
