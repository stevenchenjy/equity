...
activation_log="${project_root}/00_project_control/run_logs/daily_activation_log.csv"
...
verification = root / "00_project_control/daily_verification_report.md"
...
inhibit_target = root / "07_automation/scheduler/maintenance_inhibit.local.json"
...
log_target = root / "00_project_control/run_logs/daily_activation_log.csv"
fields = [
