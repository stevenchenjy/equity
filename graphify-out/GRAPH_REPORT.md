...
## Corpus Check
- 177 files · ~185,534 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1936 nodes · 4851 edges · 104 communities (85 shown, 19 thin omitted)
- Extraction: 83% EXTRACTED · 17% INFERRED · 0% AMBIGUOUS · INFERRED: 835 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `75d733a2`
...
### Community 2 - "AST"
Cohesion: 0.14
Nodes (51): canonical_sha256(), Provider, _append_ledger_event(), _archive_packet(), _archived_packet_index(), _atomic_private_json(), _atomic_private_text(), _contract_failure_code() (+43 more)
...
### Community 7 - "main"
Cohesion: 0.14
Nodes (25): easter_sunday(), expected_market_session(), is_us_market_session_date(), last_completed_market_session(), last_weekday(), latest_published_market_session(), notification_change_comparison(), nth_weekday() (+17 more)

### Community 8 - "ShadowLlmTests"
Cohesion: 0.13
Nodes (35): main(), append_csv_durable(), atomic_write_json(), atomic_write_text(), bool_value(), clear_automation_alert(), cycle_date(), delivery_guard() (+27 more)
...
Cohesion: 0.17
Nodes (24): notification_delivery_policy(), Return event-driven eligibility independently of scheduler time., sha256_bytes(), sha256_file(), append_delivery(), build_message(), ConfigError, correction_eligibility() (+16 more)

### Community 11 - "verify_phase5r_daily_upgrade.py"
Cohesion: 0.07
Nodes (31): InlineFacts, parse_principal_facts(), Any, datetime, HTMLParser, Path, ValueError, Extract a narrowly approved issuer cash-flow fact from official inline XBRL.  SE (+23 more)
...
Cohesion: 0.17
Nodes (26): main(), create_if_missing(), main(), main(), append_run_log(), as_float(), concentration_status(), dynamic_candidate_fit() (+18 more)
...
Cohesion: 0.16
Nodes (7): 长期研究、倍增情景与证据边界, Research and owner collaboration, 四项投资工作流标准：实施计划与验收, Automatic event modes, Evaluation, Phase 5R SHADOW_LLM, Safe preflight
...
### Community 50 - "economic_packet"
Cohesion: 0.14
Nodes (3): CandidateStabilityTests, economic_packet(), ShadowEventControlTests
...
### Community 55 - "main"
Cohesion: 0.23
Nodes (16): csv_fields(), load_positions(), Path, write_csv(), write_text(), append_c9b_log(), Path, sha256() (+8 more)
...
- **Why does `canonical_sha256()` connect `AST` to `run_phase5r_b2_full_universe_market_data.py`, `ShadowLlmTests`, `test_phase5r_active_production.py`, `main`, `main`, `ShadowLlmTests`, `PacketMarketObservationTests`, `ShadowMeasurementTests`, `phase5r_llm_contract.py`, `ShadowProviderError`, `economic_packet`, `Scoring`, `evaluate_phase5r_shadow_llm_incremental_value.py`, `verify_phase5r_c2_email_delivery_boundary.py`, `main`?**
  _High betweenness centrality (0.078) - this node is a cross-community bridge._
- **Why does `main()` connect `ShadowLlmTests` to `AST`, `test_phase5r_active_production.py`, `score_phase5r_b_candidates.py`, `ShadowLlmTests`, `verify_phase5r_daily_upgrade.py`, `phase5r_portfolio_construction.py`, `write_extension_admission_audit`, `main`, `load_inhibit`, `verify_phase5r_c2_email_delivery_boundary.py`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `B2RefreshCadenceTests` connect `B2RefreshCadenceTests` to `ShadowLlmTests`?**
