...
STATE_PATH = ROOT / "00_project_control/run_logs/phase5r_news_scheduler.local.json"
SCRIPT = ROOT / "09_scripts/phase5r/refresh_phase5r_official_news.py"
...
def run_due_news_checks(current: datetime) -> dict:
    ...
    status_script = ROOT / "09_scripts/phase5r/generate_phase5r_current_status.py"
    try:
