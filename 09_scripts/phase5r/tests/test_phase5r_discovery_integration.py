...
import run_phase5r_daily_refresh as refresh
import run_phase5r_daily_refresh_scheduler as scheduler
import score_phase5r_b2_candidates as scoring
from phase5r_c9_common import dynamic_candidate_fit
...
class IndependentDiscoveryIntegrationTests(unittest.TestCase):
    ...
    def test_only_fetch_cycle_requests_discovery_network(self):
        with patch.object(refresh.subprocess, "run") as run:
            ...
            for mode, should_fetch in ((refresh.MARKET_SNAPSHOT_FETCH, True),
                ...
                refresh.run_step("market_discovery", "phase5r_market_discovery.py", True,
    ...
    def test_bootstrap_invokes_only_discovery(self):
        ...
        self.assertTrue(args[1].endswith("phase5r_market_discovery.py"))
