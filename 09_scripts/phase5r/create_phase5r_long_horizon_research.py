...
from phase5r_daily_common import ROOT, atomic_write_json, atomic_write_text, iso_now, read_csv, read_json
from phase5r_long_horizon_research import build_long_horizon_report

REPORT_REL = Path("04_research/realtime_stock_picker_phase5r/phase5r_long_horizon_research.local.json")
MARKDOWN_REL = Path("08_reviews/current/phase5r_long_horizon_research.local.md")
POLICY_REL = Path("01_policies/phase5r_long_horizon_research_policy.json")
SIGNAL_LABELS = {
...
def main() -> int:
    ...
    report = build_long_horizon_report(
        read_csv(input_root/"03_source_data/phase5r/phase5r_daily_fundamentals.csv"),
        read_csv(input_root/"05_risk_and_positions/current_positions.local.csv"),
        read_csv(input_root/"03_source_data/phase5r/phase5r_b2_market_data_snapshot.csv"),
        policy, iso_now(), previous_report=read_json(output, {}),
        universe=read_csv(input_root/"03_source_data/phase5r/phase5r_universe_seed.csv"),
    )
