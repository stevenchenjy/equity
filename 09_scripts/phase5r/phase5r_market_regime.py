...
POLICY_PATH = ROOT / "01_policies/phase5r_market_regime_policy.json"
STATE_PATH = ROOT / "04_research/realtime_stock_picker_phase5r/phase5r_market_regime.local.json"
REPORT_PATH = ROOT / "08_reviews/current/phase5r_market_regime.local.md"
