...
HISTORY_PATH = ROOT / "03_source_data" / "equity_research" / "market_close_history.local.csv"
OUTCOME_PATH = (
    ROOT / "04_research" / "company_research"
...
FEEDBACK_PATH = (
    ROOT / "04_research" / "company_research"
    / "recommendation_feedback.local.jsonl"
)
RETROSPECTIVE_PATH = ROOT / "08_reviews" / "current" / "retrospective.local.md"
HORIZONS = (1, 5, 20, 60)
HISTORY_FIELDS = [
