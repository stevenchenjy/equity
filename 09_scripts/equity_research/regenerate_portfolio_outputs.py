...
CHILD_SCRIPTS = [
    SCRIPTS_DIR / "create_account_state.py",
    SCRIPTS_DIR / "calculate_dynamic_weights.py",
    SCRIPTS_DIR / "create_exact_action_plan.py",
    SCRIPTS_DIR / "create_cash_deployment_plan.py",
]
SCORE_FIELDS = [
    "weekly_rank",
    "ticker",
...
VALUATION_SCENARIO_PATH = (
    ROOT / "04_data" / "equity_research" / "valuation_scenarios.local.json"
)
