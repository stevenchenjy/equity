...
UNIVERSE_SEED = DATA_DIR / "universe_seed.csv"

ACCOUNT_STATE = POSITION_DIR / "current_account_state.local.json"
CURRENT_POSITIONS = POSITION_DIR / "current_positions.local.csv"
MARKET_SNAPSHOT = DATA_DIR / "market_data_snapshot.csv"
MARKET_QUALITY = DATA_DIR / "market_data_quality_report.csv"
...
C5_PACKETS = RESEARCH_DIR / "current_research_baseline.csv"
...
C9_NEW_RECOMMENDATIONS = RESEARCH_DIR / "new_candidate_recommendations.csv"
C9_MEMO = RESEARCH_DIR / "account_aware_memo.md"
C9_ALLOCATION_REPORT = RESEARCH_DIR / "allocation_report.md"
