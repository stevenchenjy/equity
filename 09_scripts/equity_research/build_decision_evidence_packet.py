...
from valuation_evidence_v1 import valuation_packet_calculations
...
ARTIFACT_INDEX_PATH = (
    ...
    / "03_source_data"
    / "equity_research"
    / "sec_filing_artifact_index.json"
)
C5_PACKET_PATH = (
    ROOT
    / "04_research"
...
C9_SCORE_PATH = (
    ...
    / "04_research"
    / "company_research"
    / "account_aware_conviction_scores.csv"
)
...
def _verified_artifact_chunks(
    ...
    *,
    ...
    allowed_root = (ROOT / "02_filings" / "issuer_filings").resolve()
