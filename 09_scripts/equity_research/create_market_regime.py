...
from daily_common import ROOT, MARKET_SNAPSHOT_PATH, atomic_write_json, atomic_write_text, iso_now, latest_published_market_session, now_et, read_csv, read_json
from market_regime import POLICY_PATH, STATE_PATH, REPORT_PATH, build_regime


def main() -> int:
    report = build_regime(read_csv(MARKET_SNAPSHOT_PATH),
                          read_csv(ROOT / "03_source_data/equity_research/universe_seed.csv"),
