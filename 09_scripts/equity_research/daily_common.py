...
INHIBIT_PATH = (
    ROOT / "07_automation" / "scheduler" / "maintenance_inhibit.local.json"
)
...
PENDING_EXECUTION_PATH = (
    ROOT / "06_execution_records" / "pending_execution_report.csv"
)
RECONCILIATION_PATH = (
    ROOT / "06_execution_records" / "reconciliation_report.csv"
)

MARKET_SNAPSHOT_PATH = (
    ROOT / "03_source_data" / "equity_research" / "market_data_snapshot.csv"
)
MARKET_QUALITY_PATH = (
    ROOT
    / "03_source_data"
...
EVIDENCE_LEDGER_PATH = (
    ROOT / "03_source_data" / "equity_research" / "daily_evidence_ledger.csv"
)
EVIDENCE_STATE_PATH = (
    ROOT / "03_source_data" / "equity_research" / "daily_evidence_state.local.json"
)
EVIDENCE_STATUS_PATH = (
    ROOT / "03_source_data" / "equity_research" / "daily_evidence_status.json"
)
FUNDAMENTALS_PATH = (
    ROOT / "03_source_data" / "equity_research" / "daily_fundamentals.csv"
)
SEC_TICKER_MAP_PATH = (
    ROOT / "03_source_data" / "equity_research" / "sec_ticker_map.local.json"
)

DAILY_DECISION_JSON_PATH = (
    ROOT / "04_research" / "company_research" / "daily_decision.json"
)
DAILY_DECISION_REPORT_PATH = (
    ROOT / "04_research" / "company_research" / "daily_decision.md"
)
DAILY_BRIEF_TEXT_PATH = (
    ROOT / "07_automation" / "email_briefs" / "daily_email_brief.txt"
)
DAILY_BRIEF_HTML_PATH = (
    ROOT / "07_automation" / "email_briefs" / "daily_email_brief.html"
)
DAILY_DECISION_STATE_PATH = (
    ROOT / "00_project_control" / "run_logs" / "daily_decision_state.local.json"
)
DAILY_DELIVERY_LEDGER_PATH = (
    ROOT / "07_automation" / "email_delivery" / "daily_delivery_ledger.csv"
)
DAILY_DELIVERY_LOCK_PATH = (
    ROOT / "00_project_control" / "run_logs" / "daily_delivery.lock"
)
DAILY_PIPELINE_LOCK_PATH = (
    ROOT / "00_project_control" / "run_logs" / "daily_pipeline.lock"
)
DAILY_REFRESH_STATE_PATH = (
    ROOT / "00_project_control" / "run_logs" / "daily_refresh_state.local.json"
)
DAILY_SCHEDULER_STATE_PATH = (
    ROOT / "00_project_control" / "run_logs" / "daily_scheduler_state.local.json"
)
DAILY_RUN_LOG_PATH = (
    ROOT / "00_project_control" / "run_logs" / "daily_run_log.csv"
)
AUTOMATION_ALERT_PATH = (
    ROOT
    / "00_project_control"
    / "run_logs"
    / "automation_alert.local.json"
)

EMAIL_CONFIG_PATH = (
    ROOT / "07_automation" / "email_delivery" / "email_config.local.json"
)
