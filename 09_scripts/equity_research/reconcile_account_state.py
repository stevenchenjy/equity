...
from account_common import csv_fields, load_positions
...
def reconcile_fill(row: dict[str, str], apply_state: bool) -> tuple[str, bool]:
    ...
    if apply_state:
        ...
        try:
            ...
            regeneration = ROOT / "09_scripts" / "equity_research" / "regenerate_portfolio_outputs.py"
            price_plan = ROOT / "09_scripts" / "equity_research" / "create_price_aware_action_plan.py"
