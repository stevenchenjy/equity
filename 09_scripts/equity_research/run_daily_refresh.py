...
# The isolated EOD-publication market importer has a bounded 33-request plan paced
...
STEP_SPECS = [
    ...
    ("market_scoring", "score_candidates.py", False),
    ("official_evidence", "refresh_daily_evidence.py", True),
    (
    ...
    ("portfolio_outputs", "regenerate_portfolio_outputs.py", False),
    ("price_aware_review", "create_price_aware_action_plan.py", True),
    (
        "daily_decision",
