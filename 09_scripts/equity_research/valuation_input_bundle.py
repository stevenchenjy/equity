...
from daily_common import ROOT
from valuation_evidence_v1 import (
    INPUT_SPECS,
...
DEFAULT_BUNDLE_PATH = (
    ROOT / "04_data" / "equity_research" / "valuation_inputs.local.json"
)
...
_SOURCE_POLICIES = {
    "sec_valuation_fact": (
        "primary_official",
        ("02_filings/issuer_filings", "03_source_data/equity_research"),
    ),
