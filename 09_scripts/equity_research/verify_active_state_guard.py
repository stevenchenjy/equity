...
INHIBIT_PATH = (
    SCHEDULER_DIR / "maintenance_inhibit.local.json"
)
ALLOWED_PATH = CONTROL_DIR / "allowed_active_inputs.csv"
DEPRECATED_PATH = CONTROL_DIR / "deprecated_workflows.csv"
STALE_REPORT_PATH = (
    CONTROL_DIR / "stale_file_guard_report.csv"
)
POLICY_PATH = CONTROL_DIR / "active_state_policy.md"
ACTIVE_CONFIG_PATH = CONTROL_DIR / "active_production_config.json"
...
def _plist_issues() -> list[str]:
    ...
    for label, job_name in ACTIVE_JOBS.items():
        ...
        expected_arguments = (
            ...
            if label == "com.steven.equity_research.dailyrefresh"
            else [
