...
SEC_ACCEPTANCE_EXTENSION_LOCK_PATH = (
    ...
    / "00_project_control"
    / "run_logs"
    / "sec_acceptance_extension.lock"
)
EXTENSION_SCHEMA_VERSION = "phase5r_sec_acceptance_extension_artifact_v1"
EXTENSION_FILE_PREFIX = "sec_acceptance_extension_"
EXTENSION_VERSION_PATTERN = re.compile(r"v([1-9]\d*)")
FORM_PATTERN = re.compile(r"(?:[A-Z0-9][A-Z0-9 .-]{0,31}|[A-Z0-9][A-Z0-9 .-]{0,29}/A)")
