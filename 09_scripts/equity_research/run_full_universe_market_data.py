...
RUN_LOG = CONTROL_DIR / "run_logs" / "market_data_run_log.csv"

UNIVERSE_PATH = DATA_DIR / "universe_seed.csv"
LOCAL_POSITIONS_PATH = ROOT / "05_risk_and_positions" / "current_positions.local.csv"
SNAPSHOT_PATH = DATA_DIR / "market_data_snapshot.csv"
QUALITY_PATH = DATA_DIR / "market_data_quality_report.csv"
CANDIDATES_PATH = DATA_DIR / "candidates_with_market_data.csv"
AUDIT_PATH = DATA_DIR / "audit_trail.csv"
DECISION_PATH = CONTROL_DIR / "data_source_decision.md"
...
def main(argv: list[str] | None = None) -> int:
    ...
    if not source_failure:
        ...
        if tactical_history and set(tactical_history) == set(tickers):
            atomic_write_json(SNAPSHOT_PATH.with_name("tactical_price_history.local.json"), {
