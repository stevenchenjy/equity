...
```text
/Users/messssi/LocalRuntime/equity/09_scripts/equity_research/run_runtime_scheduler.py
```
...
`00_project_control/run_logs/runtime_execution_log.csv`. The runtime
...
```bash
/bin/zsh /Users/messssi/LocalRuntime/equity/07_automation/scheduler/check_daily_scheduler_status.sh
```
