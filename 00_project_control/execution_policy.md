...
`python3 09_scripts/equity_research/validate_execution_fill.py --execution-id EXECUTION_ID --record-status filled --fill-date YYYY-MM-DD --fill-price CONFIRMED_PRICE --fees CONFIRMED_FEES`
...
`python3 09_scripts/equity_research/reconcile_account_state.py --execution-id EXECUTION_ID --apply`
