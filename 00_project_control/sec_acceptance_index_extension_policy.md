...
`03_source_data/equity_research/sec_submission_acceptance_index.json` remains
...
`03_source_data/equity_research/sec_acceptance_extensions/phase5r_sec_acceptance_extension_vN.json`
